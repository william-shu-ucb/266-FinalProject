...
- name: SentenceTransformer based on sentence-transformers/all-MiniLM-L6-v2
  ...
  - task:
    ...
    metrics:
    - type: pearson_cosine
      value: 0.9282974167720238
      name: Pearson Cosine
    - type: spearman_cosine
      value: 0.8605247334938395
...
print(similarities)
# tensor([[1.0000, 0.9281, 0.3151],
#         [0.9281, 1.0000, 0.3295],
#         [0.3151, 0.3295, 1.0000]])
```
...
| Metric              | Value      |
|:--------------------|:-----------|
| pearson_cosine      | 0.9283     |
| **spearman_cosine** | **0.8605** |

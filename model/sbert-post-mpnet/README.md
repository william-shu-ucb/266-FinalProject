...
- name: SentenceTransformer based on sentence-transformers/all-mpnet-base-v2
  ...
  - task:
    ...
    metrics:
    - type: pearson_cosine
      value: 0.9635257305553246
      name: Pearson Cosine
    - type: spearman_cosine
      value: 0.8650489877035991
...
print(similarities)
# tensor([[ 1.0000, -0.0556, -0.0377],
#         [-0.0556,  1.0000,  0.0217],
#         [-0.0377,  0.0217,  1.0000]])
```
...
| Metric              | Value     |
|:--------------------|:----------|
| pearson_cosine      | 0.9635    |
| **spearman_cosine** | **0.865** |
